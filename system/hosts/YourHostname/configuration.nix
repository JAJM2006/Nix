...

{
  ...
  # Locale controls date formats, paper size, currency, etc.
  # Use "en_US.UTF-8" for US English, "en_GB.UTF-8" for UK English, and so on.
  i18n.defaultLocale = "en_GB.UTF-8"; # CHANGE ME

  console.keyMap = "uk"; # CHANGE ME — "us", "de", "fr", etc.

  services.xserver.xkb = {
    layout  = "gb"; # CHANGE ME — same as console.keyMap, except gb uses "gb" not "uk"
    variant = "";
  };
  ...
  # See WINDOW_MANAGERS.md for Hyprland / Niri setup.
  # ==============================================================================
